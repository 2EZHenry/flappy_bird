	...
	show_tip(params, on_hide = null) {
		if (
			...
			if (params["img_config"]) {
				...
				let scale =
					"scale" in params["img_config"] ? params["img_config"]["scale"] : 1;
				let img_x =
					"img_x" in params["img_config"] ? params["img_config"]["img_x"] : 0;
				let img_y =
					"img_y" in params["img_config"] ? params["img_config"]["img_y"] : 0;
				let txt_x =
					"txt_x" in params["img_config"] ? params["img_config"]["txt_x"] : 0;
				let txt_y =
					"txt_y" in params["img_config"] ? params["img_config"]["txt_y"] : 0;
